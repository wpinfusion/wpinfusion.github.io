...
$toemails[] = array(
				'email' => 'info@wpinfusion.com', // Your Email Address
				'name' => 'Contact Form | WP Infusion' // Your Name
			);
...
$recaptcha_secret = '6LfQw4kUAAAAAKYWcorzYu8ZXPHob6Fu4hM9ccYP'; // Your reCaptcha Secret
...
$mail->SMTPAuth = true;
$mail->Port = 587;
$mail->Username = "info@wpinfusion.com";
$mail->Password = "ekfs4hphqug";
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	if( $_POST['template-contactform-email'] != '' ) {
		...
		if( $botcheck == '' ) {
			...
			$mail->SetFrom( "info@wpinfusion.com" , $name );
